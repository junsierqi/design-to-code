...
REQUIRED_FILES = [
    ...
    "skills/design-to-code/examples/visual-verification.json",
    "skills/design-to-code/examples/asset-manifest.json",
    "skills/design-to-code/scripts/validate_design_brief.py",
    "skills/design-to-code/scripts/inspect_frontend_project.py",
    "skills/design-to-code/scripts/run_visual_verification.py",
    "skills/design-to-code/scripts/validate_asset_manifest.py",
    ...
    "skills/design-to-code/scripts/capture_design_snapshot.py",
    "skills/design-to-code/scripts/compare_screenshots.py",
    "skills/design-to-code/scripts/ui_smoke_check.py",
    "skills/design-to-code/scripts/design_to_code_pipeline.py",
